...
public class DaoPessoa {
    ...
    public static Pessoa localizarPessoaPorId(int id) {
        Session s = ConexaoBD.getSessionFactory().openSession();
        s.beginTransaction();
    ...
    public static Pessoa localizarPessoaPorNome(String nome) {
        Session s = ConexaoBD.getSessionFactory().openSession();
        s.beginTransaction();
    ...
    public static void DeletarPessoa(Pessoa p) {
        ...
        s.getTransaction().commit();
        s.close();
        return ConexaoBD.getSessionFactory().containsFetchProfileDefinition(String.valueOf(p));
    }
